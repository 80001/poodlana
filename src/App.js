...
function App() {
    ...
    return (
        <div className="App">
            <Header />
            <div className="hidden lg:hidden absolute max-lg:flex-col max-lg:w-[100vw] max-lg:fixed z-[999] bg-white">
