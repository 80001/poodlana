    ...
    return (
        <div className="h-[72px] justify-center items-center flex w-[100vw] flex-col px-8 py-4 max-lg:max-w-full backdrop-blur-lg top-0 left-0 z-[100] fixed max-lg:bg-white max-lg:h-[64px] max-lg:px-4">
            <div className="flex w-full h-full justify-between items-center max-lg:justify-start" style={{ opacity: 1, transform: 'translateY(0px) translateZ(0px)' }}>
                ...
                <aa className="cursor-pointer flex items-center flex-1 mr-4 lg:hidden active">
                    <img src={logo} alt="" style={{ width: 126, height: 26 }} />
                </aa>
                <div className="w-[200px] max-lg:hidden">
                    <div className="relative">
                        <button className="flex items-center h-[42px] transition-all duration-200 hover:text-primary max-lg:hidden" id="headlessui-menu-button-:R5p6haj6:" type="button" aria-haspopup="menu" aria-expanded="false">
                        ...
                        <div className="hidden absolute left-0 max-lg:left-[-50%] max-lg:translate-x-[-50%] mt-2 w-[225px] divide-gray-100 bg-white border border-black" aria-labelledby="headlessui-menu-button-:R5p6haj6:" id="headlessui-menu-items-:r2:" role="menu" tabIndex="0" data-headlessui-state="open">
                ...
                <div className="flex items-center justify-between gap-[45px] max-lg:justify-center text-black text-[13px] max-lg:hidden">
                    <div className="relative">
                        <button className="align-top text-center grow whitespace-nowrap hover:cursor-pointer hover:text-primary text-opacity-60" id="headlessui-menu-button-:R1696haj6:" type="button" aria-haspopup="menu" aria-expanded="false">
                            About
                        ...
                        <div className="absolute hidden left-0 mt-2 w-[240px] bg-white border border-black" aria-labelledby="headlessui-menu-button-:R1696haj6:" id="headlessui-menu-items-:r6:" role="menu" tabindex="0" data-headlessui-state="open">
