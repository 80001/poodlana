...
import tokenpost from '../../images/tokenpost.svg'
import cointelegraphJP from '../../images/cointelegraph-jp.svg'
import cointelegraphKR from '../../images/cointelegraph-kr.svg'
import utoday from '../../images/utoday.svg'
import wallstreet from '../../images/wallstreet-online.svg'
import coinGape from '../../images/coin-gape.svg'
import next from '../../images/next-money.svg'
import amb from '../../images/amb-crypto.svg'
import block from '../../images/block-media.svg'
...
const Partners = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center overflow-x-hidden bg-black py-[22px] pb-[0px] ">
